    ...
    <div class="canvas col-md-12">
      <div class=" col-md-3 col-sm-12 col-xs-12 page-container sidebar visible-md visible-lg">
        <div class="home-page-header">
         ...
         <p class="blog-text">
          ...
          <img class="featured" src="<?php echo base_url();?>img/dolon.png" width="200" align="left" alt="Background">
        </div>
      ...
      <div class="blog col-md-8 col-md-offset-1  col-sm-12 col-xs-12">
        <div class="blog-post">
          <img class="featured" src="<?php echo base_url();?>img/bg1.jpg" width="300" alt="Background">
          <p class="blog-post-sub-title text-center"> Nature </p>
          <a href="single.html"><h3 class="blog-post-title ">FRAGMENTS OF ICELAND</h3></a>
        ...
        <div class="blog-post">
          <img class="featured" src="<?php echo base_url();?>img/bg2.jpg" width="300" alt="Background">
        ...
        <div class="blog-post">
          <img class="featured" src="<?php echo base_url();?>img/bg3.jpg" width="300" alt="Background">
        ...
        <div class="blog-post">
          <img class="featured" src="<?php echo base_url();?>img/bg.jpg" width="300" alt="Background">
      ...
      <div class=" col-md-3 col-sm-12 col-xs-12 container page-container sidebar visible-xs visible-sm">
        <div class="home-page-header1">
         ...
         <p class="blog-text">
          ...
          <img class="featured" src="<?php echo base_url();?>img/dolon.png" width="300" alt="Background">
        </div>
